 ...
 * V0 — generador Web Audio autocontenido.
 *
 * No modifica estado del runtime principal.
 * Inicializa AudioContext después de interacción del usuario.
 */
...
export class ScavengedCyberAudio {
  ...
  dispose() {
    ...
    try {
      ...
      // Audio teardown is intentionally best-effort.
    }
